            ...
            public void onFinish() {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        correctionText.setTextColor(Color.RED);
...
//-----------flag names and country name--------------------------
        ...
        final ImageView image = (ImageView) findViewById(R.id.flagImages);
        Text1 = (TextView) findViewById(R.id.text1);
        correctionText = (TextView)findViewById(R.id.correctionText);
        correctText = (TextView)findViewById(R.id.correctText);
        spinner = findViewById(R.id.spinnerDrop1);
        final TextView time=(TextView)findViewById(R.id.timerView3);
        ...
        findViewById(R.id.spinnerDrop1).setVisibility(View.INVISIBLE);
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                findViewById(R.id.spinnerDrop1).setVisibility(View.VISIBLE);
        ...
        //-----------click the submit button and show ---------------------------
        SubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //------------get spinner name and correct flag------------
                String selectedFlag = spinner.getSelectedItem().toString();
                String randomFlagName = flags.get(randomFlag);
                correctCountry = randomFlagName;

                if (randomFlagName.equals(selectedFlag)) {
                    correct = true;
                    correctionText.setText("CORRECT!");
                    correctionText.setTextColor(Color.GREEN);
                } else {
                    correct = false;
                    correctionText.setText("WRONG!");
                    correctionText.setTextColor(Color.RED);
                    correctText.setText(correctCountry);
                    correctText.setTextColor(Color.BLUE);
                }
            }
        });
        //-----------click the next button and show ---------------------------
        NextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int randImage = pic.nextInt(FlagRandom.length);
                image.setImageResource(FlagRandom[randImage]);
        ...
        //-----------get the Dropdown list from  xml--------------------
        Spinner dropdown = findViewById(R.id.spinnerDrop1);
        //-------------create list of drop down---------------------------
        String[] item1 = new String[flags.size()];
        Object[] values = flags.values().toArray();
        for (int i = 0; i < values.length; i++) {
            item1[i] = values[i].toString();
        }

        //------------ create  adapter and describe how the items are displayed--------
        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, item1);
        //----------set the drop down adapter to the before created one----------------------
